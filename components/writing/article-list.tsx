...
function ArticleRow({ article }: { article: Article }) {
  return (
    <Link
      ...
      className="-mx-2 flex items-center justify-between gap-6 rounded border-t border-border-subtle px-2 py-5 transition-colors hover:bg-surface-2 focus-visible:bg-surface-2"
    >
      <h3 className="font-sans text-base font-normal">{article.title}</h3>
      <time
