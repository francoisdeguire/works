  ...
  return (
    ...
    >
      <SwitchPrimitive.Root
        ...
        data-slot="switch"
        className={cn(
          'relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full bg-black/10 p-0.5 outline outline-black/5 -outline-offset-1 transition-[background-color] duration-150 ease-standard data-checked:bg-foreground disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-dos focus-visible:outline-offset-2',
          className,
        )}
        {...props}
      >
