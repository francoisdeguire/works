        ...
        <div className="mt-16 sm:mt-32 space-y-12 *:space-y-6 *:sm:space-y-12 sm:space-y-24 text-lg sm:text-2xl leading-loose font-medium tracking-tight text-foreground-muted [font-variation-settings:'wdth'_103]">
          ...
          <div>
            <p className="stagger-5">
              Since 2022, I've been at Volume7, where I now lead design for the 20-person fullstack
              engineering team. We ship for enterprise and high-growth clients. My work spans
              systems, tooling, and UI.
            </p>
            <p className="stagger-6">
              Before that, I worked two years at Ubisoft building developer interfaces, shipping the
              internal tools design system, and weaving design into engineering workflows.
            </p>
          </div>

          <div>
            <p className="stagger-7">
              When I'm not working you'll find me stress-testing baking recipes, writing code for
              fun, or deep in some seemingly random new hobby.
            </p>
